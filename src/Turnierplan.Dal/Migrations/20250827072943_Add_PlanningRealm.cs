...
namespace Turnierplan.Dal.Migrations
{
    ...
    public partial class Add_PlanningRealm : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeamLinks_PlanningRealms_PlanningRealmId",
                        column: x => x.PlanningRealmId,
                        principalSchema: "turnierplan",
                        principalTable: "PlanningRealms",
                        principalColumn: "Id",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeamLinks_Tournaments_TournamentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamLinks_PlanningRealmId",
                schema: "turnierplan",
                table: "TeamLinks",
                column: "PlanningRealmId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamLinks_TournamentId",
                schema: "turnierplan",
                table: "TeamLinks",
                column: "TournamentId");
