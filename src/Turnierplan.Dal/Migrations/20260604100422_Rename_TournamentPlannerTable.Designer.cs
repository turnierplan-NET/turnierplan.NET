...
namespace Turnierplan.Dal.Migrations
{
    ...
    [Migration("20260604100422_Rename_TournamentPlannerTable")]
    partial class Rename_TournamentPlannerTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Turnierplan.Core.PlanningRealm.TournamentPlanner", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Turnierplan.Core.RoleAssignment.RoleAssignment<Turnierplan.Core.PlanningRealm.TournamentPlanner>", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Turnierplan.Core.Tournament.RankingOverwrite", b =>
                {
                    ...
                    b.Property<long?>("AssignTeamTournamentId")
                        .HasColumnType("bigint");

                    b.Property<bool>("HideRanking")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Turnierplan.Core.User.User", b =>
                {
                    ...
                    b.Property<bool>("AllowCreateOrganization")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Turnierplan.Core.PlanningRealm.Application", b =>
                {
                    ...
                    b.HasOne("Turnierplan.Core.PlanningRealm.TournamentPlanner", "TournamentPlanner")
            ...
            modelBuilder.Entity("Turnierplan.Core.PlanningRealm.Label", b =>
                {
                    b.HasOne("Turnierplan.Core.PlanningRealm.TournamentPlanner", null)
                        .WithMany("Labels")
                        .HasForeignKey("TournamentPlannerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Turnierplan.Core.RoleAssignment.RoleAssignment<Turnierplan.Core.PlanningRealm.TournamentPlanner>", b =>
                {
                    b.HasOne("Turnierplan.Core.PlanningRealm.TournamentPlanner", "Scope")
                        .WithMany("RoleAssignments")
                        .HasForeignKey("TournamentPlannerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.OwnsOne("Turnierplan.Core.Tournament.ComputationConfiguration", "ComputationConfiguration", b1 =>
                        {
                            ...
                            b1.PrimitiveCollection<string>("ComparisonModes")
                                .IsRequired()
                                .HasJsonPropertyName("cmp");
                            ...
                            b1.OwnsOne("Turnierplan.Core.Tournament.FinalsRoundConfig", "FinalsRoundConfig", b2 =>
                                {
                                    ...
                                    b2.Property<bool>("EnableThirdPlacePlayoff")
                                        .HasJsonPropertyName("3rd");

                                    b2.Property<int>("FirstFinalsRoundOrder")
                                        .HasJsonPropertyName("fo");

                                    b2.PrimitiveCollection<string>("TeamSelectors")
                    ...
                    b.OwnsOne("Turnierplan.Core.Tournament.PresentationConfiguration", "PresentationConfiguration", b1 =>
                        {
                            ...
                            b1.Property<bool>("ShowPrimaryLogo")
                                .HasJsonPropertyName("ol");

                            b1.Property<int>("ShowResults")
                                .HasJsonPropertyName("o");

                            b1.Property<bool>("ShowSecondaryLogo")
                                .HasJsonPropertyName("sl");
                            ...
                            b1.OwnsOne("Turnierplan.Core.Tournament.PresentationConfiguration+HeaderLine", "Header1", b2 =>
                                {
                                    ...
                                    b2.Property<string>("CustomContent")
                                        .HasJsonPropertyName("cc");

                                    b2.HasKey("PresentationConfigurationTournamentId");

                                    b2.ToTable("Tournaments", "turnierplan");

                                    b2.HasJsonPropertyName("h1");
            ...
            modelBuilder.Entity("Turnierplan.Core.Tournament.Tournament", b =>
                {
                    ...
                    b.Navigation("RankingOverwrites");
