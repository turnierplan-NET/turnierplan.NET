...
internal sealed class GetTournamentEndpoint : EndpointBase<TournamentDto>
{
    ...
    private static async Task<IResult> Handle(
        ...
        IMapper mapper)
    {
        var tournament = await repository.GetByPublicIdAsync(id, ITournamentRepository.Include.GameRelevant | ITournamentRepository.Include.Venue | ITournamentRepository.Include.TeamsWithLinks);
