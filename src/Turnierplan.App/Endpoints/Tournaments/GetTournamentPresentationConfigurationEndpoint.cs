...
internal sealed class GetTournamentPresentationConfigurationEndpoint : EndpointBase<PresentationConfigurationDto>
{
        ...
        IMapper mapper)
    {
        ...
        return Results.Ok(mapper.Map<PresentationConfigurationDto>(tournament.PresentationConfiguration));
    }
}
