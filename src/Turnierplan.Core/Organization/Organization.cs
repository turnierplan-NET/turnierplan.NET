...
public sealed class Organization : Entity<long>, IEntityWithRoleAssignments<Organization>
{
    ...
    internal readonly List<TournamentPlanner.TournamentPlanner> _planningRealms = [];
    ...
    public IReadOnlyList<TournamentPlanner.TournamentPlanner> PlanningRealms => _planningRealms.AsReadOnly();
